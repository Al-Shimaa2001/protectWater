<template>
  <div class="min-h-screen bg-background">
    ...
    <div class="flex justify-center items-center py-20">
      <p class="text-xl text-center text-gray-800 leading-10 px-4 max-w-3xl">
        في هذا القسم، نضع بين يديك نماذج حقيقية لمشاريعنا التي نفذناها في مختلف
        مناطق السعودية، والتي تعكس مستوى الدقة والاحترافية التي نعمل بها. تشمل
        أعمالنا مشاريع عزل مائي وحراري للخزانات والحمامات والمسابح، ترميمات
        شاملة للمباني القديمة والحديثة، أعمال مكافحة حشرات وقوارض باستخدام أحدث
        التقنيات والمواد المعتمدة، بالإضافة إلى تركيب طارد الحمام وتنظيف المجالس
        والحدائق والخزانات. كل مشروع نقدمه يحمل بصمة الجودة التي نلتزم بها،
        ويأتي مع ضمان ممتد لضمان رضا عملائنا. تصفح أعمالنا لتتعرف على خبرتنا
        الواسعة وقدرتنا على تنفيذ الخدمات بكفاءة عالية وسرعة في الإنجاز.
      </p>
    </div>
...
<script setup>
definePageMeta({
  title: "أعمالنا -  شركة إعمار البلاد",
  description:
